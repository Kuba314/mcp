...
inline int stream_read_bool(unionstream_t *stream, bool *value)
{
    return stream_read_rev(stream, value, 1);
}
inline int stream_read_byte(unionstream_t *stream, int8_t *value)
{
    return stream_read_rev(stream, value, 1);
}
inline int stream_read_short(unionstream_t *stream, int16_t *value)
{
    return stream_read_rev(stream, value, 2);
}
inline int stream_read_int(unionstream_t *stream, int32_t *value)
{
    return stream_read_rev(stream, value, 4);
}
inline int stream_read_long(unionstream_t *stream, int64_t *value)
{
    return stream_read_rev(stream, value, 8);
}

inline int stream_read_ubyte(unionstream_t *stream, uint8_t *value)
{
    return stream_read_rev(stream, value, 1);
}
inline int stream_read_ushort(unionstream_t *stream, uint16_t *value)
{
    return stream_read_rev(stream, value, 2);
}
inline int stream_read_float(unionstream_t *stream, float *value)
{
    return stream_read_rev(stream, value, 4);
}
inline int stream_read_double(unionstream_t *stream, double *value)
{
    return stream_read_rev(stream, value, 8);
}
